    ...
    >
      ...
      <div className="space-y-8">
        ...
        <motion.div
          ...
          whileTap={{ scale: 0.98 }}
          className="flex justify-center" // Added to center the button and its content
        >
          <Button 
            onClick={handleBuyNow}
            className="bg-brand-pink hover:bg-brand-darkPink text-white font-medium px-8 py-8 rounded-xl text-center transition-all flex items-center justify-center gap-3 shadow-lg hover:shadow-xl text-xl"
          >
        ...
        >
          ...
          <div className="flex justify-center items-center gap-5 mt-3">
            ...
            {/* Removed Mastercard and Amex as requested */}
